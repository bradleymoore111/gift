...
world[11] = {name: '',player:{x:500,y:340,width:16,height:45,speed:3,velX:0,velY:0,jumping:false,grounded:false,hasCube:-1},critters:[],bugs:[],bread:[],boxes:[{x:10,y:360,width:40,height:40},{x:10,y:360,width:400,height:40},{x:10,y:320,width:360,height:40},{x:10,y:280,width:320,height:40},{x:10,y:240,width:280,height:40},],noJumps:[],cubes:[],plates:[],fields:[],keys:[],doors:[],goal:{x:301,y:190,width:51,height:50,action:function(){world[level].player.x=500;world[level].player.y=340;resetLevel(false);newLevel++;}},reset:function(){world[level].player.x=500;world[level].player.y=340;resetLevel(true);}}